#!/usr/bin/env python3
"""
Stockdata.org API tester for 1m and 5m OHLCV with daily caching.
...
Examples:
    python stockdata_test.py --symbols AAPL --intervals 1m 5m \
        --start 2025-10-15 --end 2025-10-16
    export STOCK_DATA_API_KEY=... \
        && python stockdata_test.py --symbols AAPL SPOT --intervals 1m \
        --start 2025-10-15 --end 2025-10-16
"""
